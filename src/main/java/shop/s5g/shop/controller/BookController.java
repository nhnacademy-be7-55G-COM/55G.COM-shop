...
//    //도서 등록
//    @PostMapping("/book")
//    public ResponseEntity<MessageDto> addBook(@Validated @RequestBody BookRequestDto bookdto, BindingResult bindingResult) {
...
//    public ResponseEntity<BookDetailResponseDto> getBookById(@Validated @PathVariable("bookId") Long bookId) {
//        if (bookId < 1) {
//            throw new BookBadRequestException("bookId must be greater than 0");
//        }
//        BookDetailResponseDto dto = bookService.getBookById(bookId);
//        return ResponseEntity.ok().body(dto);
//    }
//
//    //도서 수정
//    @PutMapping("/book/{bookId}")
//    public ResponseEntity<MessageDto> updateBook(@Validated @PathVariable("bookId") Long bookId, @RequestBody BookRequestDto bookdto) {
//        if(bookId < 1) {
//            throw new BookBadRequestException("bookId must be greater than 0");
//        }
//
